            ...
            <div className="container-custom">
                ...
                <div className="max-w-5xl mb-16 md:mb-32">
                    <motion.div {...fadeUp} className="flex items-start gap-6 md:gap-12 mb-8">
                        ...
                        <div>
                            <p className="text-xs md:text-sm tracking-[0.3em] uppercase text-text-secondary mb-4 md:mb-6 font-bold">Your Gateway to Growth</p>
                ...
                <div className="space-y-24 md:space-y-48">
                    ...
                    {/* Block 1 - Focus: Community Support */}
                    <motion.div
                        {...fadeUp}
                        ...
                        <div className="lg:col-span-5 lg:col-start-1">
                            <div className="space-y-6">
                                ...
                                <p className="text-base md:text-lg text-text-secondary leading-relaxed max-w-md">
                                    Connect with peers, share insights, and get the support you need to thrive in today&apos;s competitive landscape.
                                </p>
                            </div>
                        </div>
                        <div className="lg:col-span-6 lg:col-start-7">
                            <div className="aspect-16/10 lg:aspect-4/3 bg-linear-to-br from-primary/5 to-primary/10 rounded-3xl" />
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="lg:col-span-6 lg:col-start-1 order-2 lg:order-1">
                            <div className="aspect-16/10 lg:aspect-4/3 bg-linear-to-br from-accent/20 to-accent/5 rounded-3xl" />
                        </div>
                        <div className="lg:col-span-5 lg:col-start-8 order-1 lg:order-2">
                            <div className="space-y-6">
                                ...
                                <p className="text-base md:text-lg text-text-secondary leading-relaxed max-w-md">
                                    Access innovative resources to boost your online presence and solve the common challenges of exposure and opportunity.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="space-y-8">
                            ...
                            <p className="text-base md:text-lg text-text-secondary leading-relaxed max-w-2xl mx-auto px-4">
                                Learn from experienced leaders and accelerate your progress through strategic collaborations and forge powerful partnerships.
                            </p>
