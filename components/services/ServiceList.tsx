                        ...
                        >
                            ...
                            <div className="flex-1 w-full">
                                <div className="relative group">
                                    ...
                                    <div className="relative aspect-[3/2] md:aspect-[4/3] bg-gray-50 rounded-2xl md:rounded-[3rem] border border-border-subtle overflow-hidden flex items-center justify-center p-12 md:p-20 group-hover:border-primary/20 transition-all duration-500">
                                        ...
                                        {/* Floating Badge */}
                                        <div className="absolute top-4 left-4 md:top-12 md:left-12 p-2.5 md:p-3 bg-white rounded-xl md:rounded-2xl shadow-xl shadow-primary/5 flex items-center gap-2 md:gap-3">
                                            <div className={`w-2.5 h-2.5 md:w-3 md:h-3 rounded-full ${service.color}`} />
                                            <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-primary/40">Core Pillar</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
